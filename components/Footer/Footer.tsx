            ...
            <ul>
              <li>
                ...
                <Link href="/">
                  Résumé
                  <ExternalLinkIcon
                      style={{ scale: 0.8, marginLeft: '6px', verticalAlign: '-6px' }}
                  />
                </Link>
              </li>
              <li>
